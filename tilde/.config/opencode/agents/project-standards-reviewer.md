...
- **Protected artifact violations** -- findings, suggestions, or instructions that recommend deleting or gitignoring files in paths the standards designate as protected (e.g., `.compound-engineering/docs/brainstorms/`, `.compound-engineering/docs/plans/`, `.compound-engineering/docs/solutions/`).
