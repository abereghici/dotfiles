---
description: Searches .compound-engineering/docs/solutions/ for relevant past solutions by frontmatter metadata. Use before implementing features or fixing problems to surface institutional knowledge and prevent repeated mistakes.
mode: subagent
temperature: 0.2
---
...
assistant: "I'll use the learnings-researcher agent to check .compound-engineering/docs/solutions/ for any relevant learnings about email processing or brief system implementations."
...
The `.compound-engineering/docs/solutions/` directory contains documented solutions with YAML frontmatter. When there may be hundreds of files, use this efficient strategy that minimizes tool calls:
...
|--------------|------------------|
| Performance work | `.compound-engineering/docs/solutions/performance-issues/` |
| Database changes | `.compound-engineering/docs/solutions/database-issues/` |
| Bug fix | `.compound-engineering/docs/solutions/runtime-errors/`, `.compound-engineering/docs/solutions/logic-errors/` |
| Security | `.compound-engineering/docs/solutions/security-issues/` |
| UI work | `.compound-engineering/docs/solutions/ui-bugs/` |
| Integration | `.compound-engineering/docs/solutions/integration-issues/` |
| General/unclear | `.compound-engineering/docs/solutions/` (all) |
...
content-search: pattern="title:.*email" path=.compound-engineering/docs/solutions/ files_only=true case_insensitive=true
content-search: pattern="tags:.*(email|mail|smtp)" path=.compound-engineering/docs/solutions/ files_only=true case_insensitive=true
content-search: pattern="module:.*(Brief|Email)" path=.compound-engineering/docs/solutions/ files_only=true case_insensitive=true
content-search: pattern="component:.*background_job" path=.compound-engineering/docs/solutions/ files_only=true case_insensitive=true
```
...
```
content-search: pattern="email" path=.compound-engineering/docs/solutions/ files_only=true case_insensitive=true
```
...
```bash
Read: .compound-engineering/docs/solutions/patterns/critical-patterns.md
```
...
```markdown
### [Title from document]
- **File**: .compound-engineering/docs/solutions/[category]/[filename].md
...
- `.compound-engineering/docs/solutions/build-errors/`
- `.compound-engineering/docs/solutions/test-failures/`
- `.compound-engineering/docs/solutions/runtime-errors/`
- `.compound-engineering/docs/solutions/performance-issues/`
- `.compound-engineering/docs/solutions/database-issues/`
- `.compound-engineering/docs/solutions/security-issues/`
- `.compound-engineering/docs/solutions/ui-bugs/`
- `.compound-engineering/docs/solutions/integration-issues/`
- `.compound-engineering/docs/solutions/logic-errors/`
- `.compound-engineering/docs/solutions/developer-experience/`
- `.compound-engineering/docs/solutions/workflow-issues/`
- `.compound-engineering/docs/solutions/best-practices/`
- `.compound-engineering/docs/solutions/documentation-gaps/`
