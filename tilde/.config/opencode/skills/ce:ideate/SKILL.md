...
This workflow produces a ranked ideation artifact in `.compound-engineering/docs/ideation/`. It does **not** produce requirements, plans, or code.
...
Look in `.compound-engineering/docs/ideation/` for ideation documents created within the last 30 days.
...
- **Past learnings** — relevant institutional knowledge from .compound-engineering/docs/solutions/
...
12. Spread ideas across multiple dimensions when justified:
   ...
   - .compound-engineering/docs/knowledge compounding
...
1. Ensure `.compound-engineering/docs/ideation/` exists
2. Choose the file path:
   - `.compound-engineering/docs/ideation/YYYY-MM-DD-<topic>-ideation.md`
   - `.compound-engineering/docs/ideation/YYYY-MM-DD-open-ideation.md` when no focus exists
