...
Skip any todo that recommends deleting, removing, or gitignoring files in `.compound-engineering/docs/brainstorms/`, `.compound-engineering/docs/plans/`, or `.compound-engineering/docs/solutions/` — these are intentional pipeline artifacts.
...
GATE: STOP. Verify the compound skill produced a solution document in `.compound-engineering/docs/solutions/`. If none (user declined or no learnings), continue.
