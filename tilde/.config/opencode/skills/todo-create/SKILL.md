...
| Trigger | Flow |
|---------|------|
| Code review | `/ce:review` -> Findings -> `/skills:todo-triage` -> Todos |
| Autonomous review | `/ce:review mode:autofix` -> Residual todos -> `/skills:todo-resolve` |
| Code TODOs | `/skills:todo-resolve` -> Fixes + Complex todos |
