...
Captures problem solutions while context is fresh, creating structured documentation in `.compound-engineering/docs/solutions/` with YAML frontmatter for searchability and future reference. Uses parallel subagents for maximum efficiency.
...
#### 1. **Context Analyzer**
   ...
   - Reads `references/yaml-schema.md` for category mapping into `.compound-engineering/docs/solutions/`
...
#### 3. **Related Docs Finder**
   - Searches `.compound-engineering/docs/solutions/` for related documentation
   ...
   **Search strategy (grep-first filtering for efficiency):**
   ...
   2. If the problem category is clear, narrow search to the matching `.compound-engineering/docs/solutions/<category>/` directory
...
5. Create directory if needed: `mkdir -p .compound-engineering/docs/solutions/[category]/`
6. Write the file: either the updated existing doc or the new `.compound-engineering/docs/solutions/[category]/[filename].md`
...
- **Pattern filename or pattern topic** when the stale guidance lives in `.compound-engineering/docs/solutions/patterns/`
...
3. **Write minimal doc**: Create `.compound-engineering/docs/solutions/[category]/[filename].md` using `assets/resolution-template.md` as the base structure, with:
...
File created:
- .compound-engineering/docs/solutions/[category]/[filename].md
...
| Multiple files created during workflow | One file written or updated: `.compound-engineering/docs/solutions/[category]/[filename].md` |
...
File created:
- .compound-engineering/docs/solutions/performance-issues/n-plus-one-brief-generation.md
...
Overlap detected: .compound-engineering/docs/solutions/performance-issues/n-plus-one-queries.md
...
File updated:
- .compound-engineering/docs/solutions/performance-issues/n-plus-one-queries.md (added last_updated: 2026-03-24)
```
...
2. Document the solution → .compound-engineering/docs/solutions/performance-issues/n-plus-one-briefs.md (5 min)
...
Writes the final learning directly into `.compound-engineering/docs/solutions/`.
...
- `/research [topic]` - Deep investigation (searches .compound-engineering/docs/solutions/ for patterns)
