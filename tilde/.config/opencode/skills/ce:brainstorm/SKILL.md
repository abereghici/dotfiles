...
If the user references an existing brainstorm topic or document, or there is an obvious recent matching `*-requirements.md` file in `.compound-engineering/docs/brainstorms/`:
- Read the document
...
Ensure `.compound-engineering/docs/brainstorms/` directory exists before writing.
...
```bash
CONTENT=$(cat .compound-engineering/docs/brainstorms/YYYY-MM-DD-<topic>-requirements.md)
...
Requirements doc: .compound-engineering/docs/brainstorms/YYYY-MM-DD-<topic>-requirements.md  # if one was created
