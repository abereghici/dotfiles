...
`schema.yaml` in this directory is the canonical contract for `.compound-engineering/docs/solutions/` frontmatter written by `ce:compound`.
...
- `build_error` -> `.compound-engineering/docs/solutions/build-errors/`
- `test_failure` -> `.compound-engineering/docs/solutions/test-failures/`
- `runtime_error` -> `.compound-engineering/docs/solutions/runtime-errors/`
- `performance_issue` -> `.compound-engineering/docs/solutions/performance-issues/`
- `database_issue` -> `.compound-engineering/docs/solutions/database-issues/`
- `security_issue` -> `.compound-engineering/docs/solutions/security-issues/`
- `ui_bug` -> `.compound-engineering/docs/solutions/ui-bugs/`
- `integration_issue` -> `.compound-engineering/docs/solutions/integration-issues/`
- `logic_error` -> `.compound-engineering/docs/solutions/logic-errors/`
- `developer_experience` -> `.compound-engineering/docs/solutions/developer-experience/`
- `workflow_issue` -> `.compound-engineering/docs/solutions/workflow-issues/`
- `best_practice` -> `.compound-engineering/docs/solutions/best-practices/`
- `documentation_gap` -> `.compound-engineering/docs/solutions/documentation-gaps/`
