...
| `compound-engineering:research:learnings-researcher` | Search .compound-engineering/docs/solutions/ for past issues related to this PR's modules and patterns |
