...
| `compound-engineering:research:learnings-researcher` | Search .compound-engineering/docs/solutions/ for past issues related to this PR |
...
- `.compound-engineering/docs/brainstorms/*` -- requirements documents created by ce:brainstorm
- `.compound-engineering/docs/plans/*.md` -- plan files created by ce:plan (living documents with progress checkboxes)
- `.compound-engineering/docs/solutions/*.md` -- solution documents created during the pipeline
...
6. **Learnings & Past Solutions.** Surface learnings-researcher results: if past solutions are relevant, flag them as "Known Pattern" with links to .compound-engineering/docs/solutions/ files.
...
5. **Protected artifacts are respected.** Discard any findings that recommend deleting or gitignoring files in `.compound-engineering/docs/brainstorms/`, `.compound-engineering/docs/plans/`, or `.compound-engineering/docs/solutions/`.
